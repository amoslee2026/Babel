...
| 目标算力 | 0.25 TOPS FP32 / 0.5 TOPS FP16 / 1 TOPS INT8 |
...
| Bank | 地址范围 | 容量 | 选择逻辑 |
|------|----------|------|---------|
| Bank 0 | 0x00000 - 0x07FFF | 128 KB | addr[18:17] = 00 |
| Bank 1 | 0x08000 - 0x0FFFF | 128 KB | addr[18:17] = 01 |
| Bank 2 | 0x10000 - 0x17FFF | 128 KB | addr[18:17] = 10 |
| Bank 3 | 0x18000 - 0x1FFFF | 128 KB | addr[18:17] = 11 |
...
| Phase 1 | M07_ResetManager | io | 是 | M06 |
...
3. **模块依赖图决定了实现顺序**。NPU 的 8 个核心模块分 5 个 Phase 实现，同 Phase 内的模块可以并行生成 RTL，提高 Agent 的工作效率。
